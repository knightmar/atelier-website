  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="md:col-span-2 bg-white dark:bg-gray-900 p-8 rounded-2xl border border-black dark:border-gray-800 shadow-xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-black rounded-lg flex items-center justify-center text-makerlab hover:scale-110 transition-transform" title="Instagram">
              ...
              <a href="#" className="w-10 h-10 bg-black rounded-lg flex items-center justify-center text-makerlab hover:scale-110 transition-transform" title="Discord">
